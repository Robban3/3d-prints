...
// Bakom en proxy är req.ip annars alltid proxyns adress, vilket gör
// takgränserna verkningslösa.
...
app.use(
  helmet({
    contentSecurityPolicy: {
      directives: {
        defaultSrc: ["'self'"],
        // Klarnas widget laddas från deras CDN och renderas i en iframe.
        scriptSrc: ["'self'", 'https://x.klarnacdn.net', 'https://*.klarna.com'],
        frameSrc: ["'self'", 'https://*.klarna.com', 'https://*.klarnacdn.net'],
        connectSrc: ["'self'", 'https://*.klarna.com', 'https://*.klarnacdn.net'],
        imgSrc: ["'self'", 'data:', 'https://*.klarnacdn.net'],
    ...
    // Uppladdade modellfiler laddas ned från samma ursprung.
