  ...
  return (
    <div className="panel">
      <div className="spread">
        ...
        <span className="badge badge-accent">{statusLabels[order.status] ?? order.status}</span>
      </div>
          ...
          <table className="spec-table">
            <tbody>
              <tr>
                ...
                <td>
                  {order.fileUrl ? (
                    <a href={order.fileUrl} className="file-link">
                      {order.fileName}
                      {order.fileSize ? ` (${formatBytes(order.fileSize)})` : ''}
                    </a>
                  ) : (
                    'Ingen fil bifogad – vi hör av oss om underlaget'
                  )}
                </td>
              </tr>
              <tr>
