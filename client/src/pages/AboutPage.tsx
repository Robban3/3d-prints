...
export function AboutPage() {
  return (
    <>
      <PageHeader
        eyebrow="Om Formlabb"
        title="Åtta maskiner, en verkstad, inga mellanhänder"
        text="Formlabb började som två printare i ett källarförråd på Hisingen och är i dag en verkstad på Tredje Långgatan med åtta maskiner igång."
      />

      <section className="section">
        <div className="container receipt">
          <p className="muted">
            Vi ritar våra egna produkter, printar dem i små serier och tar samtidigt emot
            kunduppdrag – från en enda reservdel till serier på hundratals delar. Allt spillmaterial
            mals ned och blir nytt filament, och vi skickar i papper i stället för plast. Det gör
            inte oss klimatneutrala, men det gör skillnaden mätbar.
          </p>
            ...
            <div className="grid-2">
              <div>
                ...
                <p className="muted" style={{ fontSize: '0.93rem', marginBottom: 0 }}>
                  59 kr spårbart med PostNord, fritt över 599 kr. Vi packar i returkartong så att en
                  eventuell retur inte kräver nytt emballage.
                </p>
              </div>
              <div>
                <h3>Kontakt</h3>
          ...
          <div className="panel center" style={{ marginTop: 40 }}>
            ...
            <p className="muted">Räkna ut vad den kostar att printa – det tar tjugo sekunder.</p>
