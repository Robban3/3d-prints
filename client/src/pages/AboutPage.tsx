  ...
  return (
    <section className="section">
      <div className="container receipt">
        ...
        <p className="muted">
          Formlabb började som två printare i ett källarförråd på Hisingen och är i dag en verkstad
          på Tredje Långgatan med åtta maskiner igång. Vi ritar våra egna produkter, printar dem i
          små serier och tar samtidigt emot kunduppdrag – från en enda reservdel till serier på
          hundratals delar.
        </p>
        <p className="muted">
          Allt spillmaterial mals ned och blir nytt filament, och vi skickar i papper i stället för
          plast. Det gör inte oss klimatneutrala, men det gör skillnaden mätbar.
        </p>
