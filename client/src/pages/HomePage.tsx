      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <p className="lead">
              Fjorton egendesignade produkter för hem och kontor – och en
              verkstad som lika gärna printar din egen fil. Ladda upp en modell
              så får du pris och leveranstid på sekunden.
            </p>
        ...
        <div className="container">
          <div className="spread section-head">
            <div>
              ...
              <p>
                Fyra produkter som lämnar verkstaden i högst takt den här
                månaden.
              </p>
            </div>
          ...
          <div className="panel" style={{ padding: "clamp(28px, 5vw, 52px)" }}>
            <div className="hero-grid">
              <div>
                ...
                <p className="muted">
                  Prototyper, reservdelar till diskmaskinen, en modell till
                  examensarbetet eller 200 giveaways till mässan. Fyll i
                  formuläret så räknar vi fram pris och leveransdatum medan du
                  skriver, innan du bestämmer dig.
                </p>
                <ol
                  className="stack"
              ...
              >
                ...
                >
                  Exakt pris får du direkt i formuläret. Startavgiften på 95 kr
                  tas ut en gång per order, oavsett antal.
                </p>
              </div>
            </div>
          </div>
