...
export function MaterialPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Material"
        title="Fem material att välja mellan"
        text="Valet styr både hur detaljen känns i handen och vad den tål – här är skillnaderna, och vad de kostar i förhållande till varandra."
      />
      <section className="section">
        <div className="container">
          ...
          <div className="panel" style={{ marginTop: 26 }}>
            ...
            <p className="muted">
              Lagerhöjden avgör hur mycket lagerlinjerna syns. Finare lager tar längre tid och
              kostar därför mer i maskintid.
            </p>
